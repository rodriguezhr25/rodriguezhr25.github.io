...
const apiURLCurrent = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=bc07e7e42f613427f563eb21cda2609d";
fetch(apiURLCurrent)
...
const apiURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=bc07e7e42f613427f563eb21cda2609d";
fetch(apiURL)
    .then((response) => response.json())
    .then((jsObject) => {
        console.log(jsObject);
